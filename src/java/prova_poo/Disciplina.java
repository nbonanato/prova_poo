...
public class Disciplina {
    ...
    public static void insert(String nome, String ementa, int ciclo, float nota) {
        Connection con = null;
     ...
     public static void update(String nomeAntigo, String nome, String ementa, int ciclo, float nota) {
        Connection con = null;
           PreparedStatement stmt = null;
           Exception methodEx = null;
           ResultSet rs = null;
